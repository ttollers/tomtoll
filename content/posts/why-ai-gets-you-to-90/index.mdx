...
date: 2026-02-04
description: Claude Code is gut-wrenchingly good. But the last 10% is going to kill you.
tags:
  - AI
  - Engineering
  - Productivity
...
But how much are the productivity gains? The thought-leaders seem to have VERY strong opinions that it's a large number followed by an "x".
...
How can we prevent ourselves being bogged down by the final 10%?

**Lower your standards**

Perhaps 90% is fine. Most things don't need to be perfect - you can see if anyone notices the missing 10%. If nobody notices the missing 10%, it wasn't missing, it was extraneous.
...
Kick off a task, let it run and come back to it. Have 10 of them going in parallel. If you ever find yourself waiting for an AI to respond - you're wasting time.

We are no longer solitary craftsmen; we are middle managers in a sweatshop of hallucinations. It is efficient, it is lucrative, and it is roughly as satisfying as herding cats through a minefield. But the cats are very, very fast, so I suppose we’d better start running.
